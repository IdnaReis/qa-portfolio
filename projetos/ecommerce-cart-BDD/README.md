...
## 🎯 Objetivo
Validar a funcionalidade do carrinho de compras garantindo que produtos possam ser adicionados, removidos, atualizados e que o valor total seja calculado corretamente.
...
```
 ...
 ## 📌 Observações
Casos escritos em Gherkin para facilitar comunicação entre QA, Dev e Negócio.
...
Git → Versionamento dos scripts de automação

Cucumber → Automação dos cenários BDD
